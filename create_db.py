...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'otoluwan', 'email': 'otoluwan@terpmail.umd.edu', 'first_name': 'Ore', 'last_name': 'Toluwani',
         'password': generate_password_hash('otoluwan', method='pbkdf2:sha256'), 'role': 'STUDENT'},
