...
with app.app_context():
    ...
    students = [
        ...
        {'student_id': '2', 'first_name': 'Leo', 'last_name': 'Van Munching', 'email': 'leo.vmunching@gmail.com','major_id':6,
    ...
    for each_student in students:
        ...
        a_student = Student(first_name=each_student["first_name"], last_name=each_student["last_name"], email=each_student["email"], major_id=each_student["major_id"], birth_date=each_student["birth_date"],
